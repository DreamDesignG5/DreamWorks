...
export default function ThirdBlock() {
  return (
    <div
      className={
        "flex flex-col py-24 bg-green-800 px-10 lg:px-40  h-screen w-full"
      }
    >
      <div className={"flex flex-col space-y-1"}>
        ...
        <span
          className={
            "text-sm tracking-wider text-gray-200 w-80   transform -skew-x-6  "
          }
        >
          With cutting edge technolody we make everything reliable, fast, secure
        </span>
      </div>

      <button
        className={
          "group w-32 mt-28 flex h-8 flex-shrink-0   border rounded-none hover:border-none hover:shadow-xl border-gray-300 overflow-hidden relative  py-1.5"
        }
      >
        <div
          className={
