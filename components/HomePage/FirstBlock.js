...
export default function FirstBlock() {
  return (
    <div className={"flex  relative flex-col py-52   px-10 lg:px-40   w-full"}>
      <img
      ...
      <div
        className={
          "absolute object-cover inset-0 bg-gradient-to-br from-purple-600  via-red-500 to-red-500 opacity-80"
        }
      ></div>
      ...
      <div className={"flex flex-col space-y-5"}>
        <span
          className={
            "text-3xl z-10 max-w-sm lg:max-w-md text-gray-200 font-robotocondensed tracking-wide"
          }
        >
